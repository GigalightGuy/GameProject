...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    ...
    private fun sendNotification(messageBody: String) {
        ...
        val notificationBuilder = NotificationCompat.Builder(this, channelId)
            .setSmallIcon(R.drawable.straight_face)
            .setContentTitle("Straight Face Adventure")
    ...
    companion object {
        ...
        const val BROADCAST_NET_NOTIFICATION = "ipca.gameproject.a21080.notification"
        const val NOTIFICATION_MESSAGE = "ipca.gameproject.a21080.notification.message"
    }
}